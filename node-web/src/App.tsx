...
function errorText(value: unknown): string {
  ...
  const setupMessages: Record<string, string> = {
    setup_secure_store_unavailable: "系统安全存储不可用。请解锁登录钥匙串后重试。",
