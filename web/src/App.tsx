...
function LoadingScreen() {
  return <main className="loading-screen"><span className="brand-mark">枢</span><h1>正在恢复工作台</h1><p>从浏览器安全存储读取控制端身份和本地上下文。</p><div className="loading-line" /></main>;
}
