...
func relayHTTPSBase(relayURL string) (string, error) {
	...
	parsed.Scheme, parsed.Path, parsed.RawPath = "https", "", ""
...
func validEnrollmentURL(raw, relayURL string) bool {
	...
	return err == nil && baseErr == nil && parsed.Scheme == "https" && parsed.User == nil && parsed.RawQuery == "" && parsed.Fragment != "" && parsed.Scheme+"://"+parsed.Host == base
}
